...
CREATE POLICY "Permissao Total Participante Chat" ON chats_classificados FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Permissao Total Participante Mensagens" ON mensagens_chats FOR ALL USING (true) WITH CHECK (true);
